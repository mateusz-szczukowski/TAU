...
public class ArrayListDietServiceTests {
    ...
    public void testAddingNewDietAsNull() {
        Diet diet = null;
        Diet addedDietAsNull = service.create(diet);
    }
    ...
    public void testThrowExceptionWhenNoDietsWereAdded() { Diet diet = service.read(1); }
